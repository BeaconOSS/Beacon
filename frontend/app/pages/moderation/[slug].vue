      ...
      <template v-else-if="pendingReview && project">
        ...
        <div class="grid gap-6 lg:grid-cols-3">
          <div class="space-y-6 lg:col-span-2">
            ...
            <ReviewListingChanges
              :review="pendingReview"
              :diffs="reviewDiffs"
              :with-base="pendingWithBase"
              @open-lightbox="openLightbox"
            />
            <ReviewLinks v-if="links.length" :links="links" />
            <ReviewGallery
              :gallery="pendingReview.gallery"
              :with-base="pendingWithBase"
              @open-lightbox="openLightbox"
            />
            <ReviewVersions
              :versions="pendingReview.versions"
              :downloading-version="downloadingVersion"
          ...
          <aside class="space-y-6">
            ...
            <ReviewHistory
              :history="pendingReview.history"
              :expanded="expandedHistory"
              :clamp="historyNoteClamp"
