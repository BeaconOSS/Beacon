  ...
  <div class="card-glass rounded-2xl p-6">
    ...
    <div class="space-y-6">
      ...
      <div class="space-y-2">
        ...
        >
          <span class="text-muted-foreground shrink-0 pl-3 select-none">
            /{{ username }}/
          </span>
          <input
            id="project-url"
      ...
      <div class="space-y-2">
        ...
        <p
          class="text-xs"
          :class="
            summaryLength >= 30 ? 'text-muted-foreground' : 'text-amber-500'
          "
        >
          {{ summaryLength }} characters - at least 30 is recommended.
        </p>
      </div>
