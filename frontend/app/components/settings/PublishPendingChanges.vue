    ...
    <div class="mb-5 flex items-start gap-3">
      ...
      <div>
        ...
        <p class="text-muted-foreground mt-1 text-sm">
          These edits are saved, but your public page still shows the last
          approved version. Submit them for review to make them live.
        </p>
      </div>
    </div>
      ...
      <table class="w-full text-sm">
        ...
        <tbody>
          ...
          >
            ...
            >
              <span v-if="row.long" class="text-muted-foreground/70 italic"
