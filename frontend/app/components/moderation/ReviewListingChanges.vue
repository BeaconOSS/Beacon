...
<template>
    ...
    <table class="w-full text-sm">
      <thead>
        <tr class="bg-background/40 text-muted-foreground text-left">
          ...
          <th v-if="!review.is_first_review" class="px-3 py-2 font-medium">
            Current (live)
          </th>
  ...
  >
    ...
    <div class="flex items-center gap-3">
      <div
        v-if="!review.is_first_review && review.published?.icon_url"
