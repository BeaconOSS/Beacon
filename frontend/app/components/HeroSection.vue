...
<template>
  <section class="relative overflow-hidden px-6 py-20 md:py-28">
    <div class="mx-auto max-w-5xl text-center">
      <div
        class="border-border bg-card/60 text-muted-foreground mb-6 inline-flex items-center gap-2 rounded-full border px-3 py-1 text-xs font-medium backdrop-blur"
      >
      ...
      <p
        class="text-muted-foreground mx-auto mb-9 max-w-2xl text-lg md:text-xl"
      >
        Discover Add-Ons, worlds, resource packs, and skins - or publish your
        own. Every BeaconOSS project is open source, and our profits go to
        charity.
      </p>

      <form
        class="mx-auto mb-5 flex max-w-2xl items-center gap-2"
