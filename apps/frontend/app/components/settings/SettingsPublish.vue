...
<template>
	<section class="space-y-8">
		...
		<PublishPendingChanges v-if="hasPendingChanges" :pending-changes="pendingChanges" :icon-changed="iconChanged" :published-icon-url="publishedIconUrl" :icon-url="iconUrl" />
