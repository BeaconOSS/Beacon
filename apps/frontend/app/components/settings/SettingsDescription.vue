    ...
    <div class="card-glass space-y-5 rounded-2xl p-6">
      <div>
        ...
        <p class="text-muted-foreground text-sm leading-relaxed">
          Use this space for a full, extended description of your project - what
          it is, what it adds, how it works, and how to use it. It must be
          honest and accurately reflect the actual project: don't promise
          features it doesn't have or misrepresent what players will get. Full
      ...
      <div class="flex flex-wrap items-center justify-between gap-2">
        <p
          class="text-xs"
          :class="
            descriptionLength < RECOMMENDED_DESCRIPTION_LENGTH
              ? 'text-amber-500'
              : 'text-muted-foreground'
          "
        >
          {{ descriptionLength }} characters ·
          {{ RECOMMENDED_DESCRIPTION_LENGTH }}+ recommended
        </p>
        <a
      ...
      <div
        ...
        :class="descriptionError ? 'sm:justify-between' : 'sm:justify-end'"
      >
