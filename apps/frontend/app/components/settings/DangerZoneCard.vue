...
<template>
  <div class="border-destructive/40 rounded-2xl border p-6">
    ...
    <p class="text-muted-foreground mb-4 text-sm">
      Removes your project from Beacon's servers and search. This action is
      permanent, so be extra careful.
    </p>
    ...
    <Button v-else variant="destructive" @click="confirming = true">
      Delete project
    </Button>
  </div>
</template>
