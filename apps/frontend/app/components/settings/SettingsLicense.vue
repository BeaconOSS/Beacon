  ...
  <section class="card-glass space-y-5 rounded-2xl p-6">
    <div>
      ...
      <p class="text-muted-foreground text-sm leading-relaxed">
        Choose the license your project is distributed under. This tells people
        what they're allowed to do with your content. If you're not sure, "All
        Rights Reserved" keeps every right with you.
      </p>
    </div>
