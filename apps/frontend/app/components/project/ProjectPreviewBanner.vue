...
<template>
  ...
  >
    ...
    <div class="min-w-0">
      <h2 class="text-foreground font-semibold">Preview of pending changes</h2>
      <p class="text-muted-foreground mt-1 text-sm leading-relaxed">
        This is how the page will look once the submitted changes are approved.
        It isn't the version shown publicly.
      </p>
      <NuxtLink
        :to="`/projects/${slug}`"
