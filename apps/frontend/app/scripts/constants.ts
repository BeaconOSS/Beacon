...
export const STAFF_ROLES: readonly UserRole[] = [USER_ROLE.MODERATOR, USER_ROLE.ADMIN];
...
export type VersionChannel = (typeof VERSION_CHANNEL)[keyof typeof VERSION_CHANNEL];
