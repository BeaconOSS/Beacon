...
export function useSettingsActions(ctx: SettingsActionsContext) {
	...
	async function patchAndReload(flags: { saving: Ref<boolean>; error: Ref<string> }, body: Record<string, unknown>, messages: { fallback: string; status?: Record<number, string> }): Promise<void> {
